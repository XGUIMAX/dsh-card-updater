...
┌────────────────────────────────────────────────┐
│ 卡片更新器                    [检测全部] [保存] │
│ C:\...\data\resources\cards                    │
│ [卡片][合并设置] │ 策略：… │ [手动备份][还原]   │
├────────────────────────────────────────────────┤
│ [头像] 姬侠传v0.5.6                [主要链接已最新] │
│        MVU 版：姬侠传v0.5.6 MVU版本.json        │
│  原版卡     C:\...\姬侠传v0.5.6.json    [选择]  │
│  主要链接   https://discord.com/...     [打开]  │
│  版本关键词 姬侠传                              │
│  MVU 版     C:\...\姬侠传v0.5.6 MVU版本.json │
│  来源检索  未发现比本地更新的版本（页面 V1.2）   │
│              [检测][跳转到原贴][导入新版]       │
│              [合并到 MVU][更新并合并][删除]     │
└────────────────────────────────────────────────┘
```
